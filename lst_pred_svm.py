...
# import shapefile for zonal aggregation, city dependent classes
if city == "la":
...
#### extract to shapefile or import as rasters
stats = ['mean']
if ext_shp:
    # single band
...
fic = pd.DataFrame([model.class_weight_], columns = [cols]).T
print("class weights:")
print(fic)
